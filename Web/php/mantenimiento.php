...
<div class="tabla_mantenimiento">
  <table>
    ...
    <?PHP
      ...
      $sql = "SELECT p.idProducto, p.nombre_p, p.descripcion_p, p.precio, p.stock, p.color_p, p.tamaño_p, p.marca_p, p.modelo_p, p.año_p, p.dureza_p, p.forma_p, p.temperatura_p, p.foto_p, p.idcategoria, p.estado, c.nombre_c FROM tblproducto as p INNER JOIN tblcategoria as c ON p.idcategoria = c.idcategoria WHERE p.estado = 1 ORDER BY p.idProducto ASC" ;
